import { version, readonly, useSSRContext, defineComponent, h, Suspense, nextTick, Transition, computed, provide, reactive, getCurrentInstance, ref, resolveComponent, shallowRef, isReadonly, mergeProps, withCtx, createTextVNode, unref, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, onServerPrefetch, inject } from 'vue';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/api-routes-a3c6ce60.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-ba6032f2.mjs').then((m) => m.default || m)
  },
  {
