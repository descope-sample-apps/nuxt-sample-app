import { version, defineAsyncComponent, readonly, useSSRContext, defineComponent, h, Suspense, nextTick, Transition, computed, provide, reactive, getCurrentInstance, ref, resolveComponent, shallowRef, isReadonly, mergeProps, withCtx, createTextVNode, unref, createApp, toRef, isRef, onErrorCaptured, onServerPrefetch, inject } from 'vue';
import { $fetch as $fetch$1 } from 'ofetch';
import { createHooks } from 'hookable';
import { getContext, executeAsync } from 'unctx';
import { hasProtocol, isEqual, parseURL, joinURL } from 'ufo';
import { u as useRuntimeConfig$1, l as createError$1, a as sendRedirect, g as appendHeader } from '../nitro/config.mjs';
...
defuFn(inlineConfig);
const components = {
  NavBar: defineAsyncComponent(() => Promise.resolve().then(function() {
    return NavBar;
  }).then((c) => c.default || c)),
  Protected: defineAsyncComponent(() => import(
    './_nuxt/Protected-b3995346.mjs'
    /* webpackChunkName: "components/protected" */
  ).then((c) => c.default || c)),
  Welcome: defineAsyncComponent(() => import(
    './_nuxt/Welcome-f3768601.mjs'
    /* webpackChunkName: "components/welcome" */
  ).then((c) => c.default || c)),
  APITableRow: defineAsyncComponent(() => import(
    './_nuxt/APITableRow-12d3efd7.mjs'
    /* webpackChunkName: "components/a-p-i-table-row" */
  ).then((c) => c.default || c))
};
...
const __nuxt_page_meta$1 = { auth: false };
const __nuxt_page_meta = {};
const _routes = [
  {
    name: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) ?? "api-routes",
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/api-routes",
    children: [],
    meta: __nuxt_page_meta$2,
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/api-routes-ffc4a6a1.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-d1d77d02.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "protected-page",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/protected/page",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/page-1f81a5bc.mjs').then((m) => m.default || m)
  }
];
...
const _imports_0 = "" + __publicAssetsURL("img/descope-logo.png");
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "NavBar",
  __ssrInlineRender: true,
  setup(__props) {
    const { status, data, signOut: signOut2, signIn: signIn2 } = useSession();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = __nuxt_component_0;
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "bg-black" }, _attrs))}><div class="container mx-auto px-6 py-3"><div class="flex justify-between items-center"><a href="https://descope.com" target="_blank"><img${ssrRenderAttr("src", _imports_0)} alt="Descope Logo" class="w-32"></a><div class="space-x-4 hidden md:flex">`);
      ...
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Protected Page `);
          } else {
            return [
              createTextVNode(" Protected Page ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><div class="space-x-4 flex items-center">`);
      if (unref(status) === "authenticated") {
        _push(`<button class="hidden md:block bg-red-600 hover:bg-red-600 text-white font-semibold py-1 px-6 rounded-md border border-red-500 hover:border-red-600 transition duration-300 shadow-md"><span>Logout</span></button>`);
      } else {
        _push(`<button class="hidden md:block bg-gray-700 hover:bg-gray-600 text-white font-semibold py-1 px-6 rounded-md border border-gray-600 hover:border-gray-500 transition duration-300 shadow-md"><span>Login</span></button>`);
      }
      _push(`<div class="border-l-2 border-gray-700 h-5 mx-4"></div><a href="https://github.com/descope" target="_blank" class="text-gray-400 hover:text-white transition duration-300"><i class="fa-brands fa-github text-lg"></i></a><a href="https://authtown.slack.com" target="_blank" class="text-gray-400 hover:text-white transition duration-300"><i class="fa-brands fa-slack text-lg"></i></a></div></div></div></nav>`);
    };
  }
});
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen h-full relative bg-gray-100 pb-20" }, _attrs))}>`);
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component-813ab52c.mjs').then((r) => r.default || r));
...
export { __nuxt_component_0 as _, useHead as a, createError as c, entry$1 as default, useSession as u };
