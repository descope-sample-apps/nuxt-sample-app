...
const _nvWF3vQLBP = defineNitroPlugin(() => {
  try {
    getServerOrigin();
  } catch (error) {
    {
...
const _lazy_pOF6eA = () => import('../healthz.mjs');
const _lazy_kiC4Wi = () => import('../_..._.mjs');
const _lazy_gBwwV2 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/healthz', handler: _lazy_pOF6eA, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/**', handler: _lazy_kiC4Wi, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_gBwwV2, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_gBwwV2, lazy: true, middleware: false, method: undefined }
];
