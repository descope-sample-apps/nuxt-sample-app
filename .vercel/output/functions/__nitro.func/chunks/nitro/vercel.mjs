...
import { t as toRouteMatcher, c as createRouter, e as eventHandler, u as useRuntimeConfig, s as setHeaders, a as sendRedirect, d as defineEventHandler, h as handleCacheHeaders, b as createEvent, f as setCookie, g as appendHeader, p as parseCookies, i as getHeaders, j as getMethod, k as getQuery, l as createError, m as isMethod, r as readBody, n as getRequestHeader, o as getRequestHeaders, q as setResponseHeader, v as createApp, w as createRouter$1, x as lazyEventHandler, y as toNodeListener } from './config.mjs';
import { withoutBase, parseURL, joinURL, withQuery, parseQuery } from 'ufo';
...
const _Tta6vouNny = defineNitroPlugin(() => {
  try {
    getServerOrigin();
  } catch (error) {
    {
...
const _lazy_6nNzW5 = () => import('../healthz.mjs');
const _lazy_BEY2fE = () => import('../_..._.mjs');
const _lazy_wrvhCO = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/healthz', handler: _lazy_6nNzW5, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/**', handler: _lazy_BEY2fE, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_wrvhCO, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wrvhCO, lazy: true, middleware: false, method: undefined }
];
...
export { NuxtAuthHandler as N, getRouteRules as g, useNitroApp as u, vercel as v };
